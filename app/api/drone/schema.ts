...
// NOTE: Keep scope small; gorilla eligibility is enforced later via player-state gating.
export const EffectScope = z.enum(["droneOnly", "droneAndHeroes"]);
...
export const ComponentUpgradeModel = z
  .object({
...
export const DroneComponentSchema = z
  .object({
    id: z.string().min(1),
...
export const CombatBoostRulesSchema = z
  .object({
...
export const ChipSetUnlockSchema = z
  .object({
...
export const CombatStageUnlockSchema = z
  .object({
...
export const DroneCatalogSchema = z
  .object({
